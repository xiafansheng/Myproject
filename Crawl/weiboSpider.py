...
class Weibo(object):
    cookie = {'Cookie': 'ALF=1567827279; _T_WM=53815157429; SUB=_2A25wT-zxDeRhGeRJ7FMS9SrKyziIHXVTs_S5rDV6PUJbkdANLUbckW1NUkf_-wi5y-bOkhH2iloDb-7YmT7JU4K3; SUHB=0U1YIVRNYEcaND; SCF=AnmO1a1WMSCw7wzhTUP-mMANO850QS4slp9Su-zGk2MM62NA8dv23AtVyRnhhFtpLzm0irSeYAfhPrRt995HioE.; SSOLoginState=1565236385; MLOGIN=1; M_WEIBOCN_PARAMS=lfid%3D102803%26luicode%3D20000174; WEIBOCN_FROM=1110106030'}  # 将your cookie替换成自己的cookie
...
def main():
    try:
        ...
        user_id = 1402400261  # 可以改成任意合法的用户id（爬虫的微博id除外）
